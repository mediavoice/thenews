(function() {
    ...
    q().push(["setPropertyID", "NA-CONDNASTTRAV-11236271"]);
    ...
    q().push(["insertPreview", {
        ...
        unit: {
            "server": "mvdirect",
            "id": "63664ae7e8bd463b9b6f2ee545f953bb"
        },
        location: "#panel > div > div > div:nth-child(1) > p:nth-child(7)",
        ...
        onRender: function($element) {
            jQuery('#sidebar-wrap > a').remove();
            jQuery('#sidebar-wrap > div.rad.box.sidebar-rad.marg-b-med.sidebar-inview').remove();
        },
...
"    src: url('https://static.polarcdn.com/vendor/fonts/BrandonText-Bold.otf') format('opentype');",
"}",            
".plr-promo-unit {",
